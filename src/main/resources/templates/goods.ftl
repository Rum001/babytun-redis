        ...
        <div class="layui-col-xs8" style="padding: 10px">
            <ul class="bb-info">
                ...
                <li style="color: darkgrey">
                    <span>宝宝团价：</span><span style="font-size: 26px;color: orange;font-weight: bold">${goods.originalCost?string("￥0.00")}</span><span
                        style="text-decoration: line-through">${goods.currentPrice?string("￥0.00")}</span>
                </li>
